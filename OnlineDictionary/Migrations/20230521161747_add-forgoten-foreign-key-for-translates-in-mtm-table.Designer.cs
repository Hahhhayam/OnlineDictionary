...
namespace OnlineDictionary.Migrations
{
    ...
    [Migration("20230521161747_add-forgoten-foreign-key-for-translates-in-mtm-table")]
    partial class addforgotenforeignkeyfortranslatesinmtmtable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlineDictionary.API.Models.DictsTranslate", b =>
                {
                    ...
                    b.HasOne("OnlineDictionary.API.Models.Translate", "Translate")
                        .WithMany("DictsTranslates")
